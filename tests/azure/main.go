...
func main() {
	...
	tCommand.SetArgs([]string{
		"import",
		"azure",
		"-r=virtual_network,subnet",
		"-R=jegan-test-RGroup",
		"--filter=Name=name;Value=jegan-test",
		//"--filter=resource_group=/subscriptions/64d22802-2f81-4581-8dcc-865126631a8c/resourceGroups/Jegan-Dev_group",
